<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userlogin.aspx.cs" Inherits="AutoMobile.UILayer.userlogin" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style6">&nbsp; <strong>
                <asp:Label ID="Label2" runat="server" CssClass="auto-style5" Text="User Login"></asp:Label>
                </strong>
                <br />
                <br />
                <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td class="auto-style7">
                ...
                <br />
                <br />
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/adminlogin.aspx">I&#39;m Admin? Login</asp:HyperLink>
            </td>
        </tr>
    </table>
</form>
